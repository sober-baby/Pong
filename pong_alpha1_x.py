...
# Alpha 3.0 uses a simple logic to improve what to do when the ball is hit to the other
# Alpha 3.0 uses the imperfect prediction of where the ball will land, because it can adjust later on
# advice: what to do when hit is ball can be improved in Beta 2.0, when attack method is finished
# may use precise def
# may consider the median to possible landings
# only defense, no attack method is considered
# alpha 3.0 胜率趋于2.5:1....正在debug
...
#exist error in wall bounce? almost none with acc_predict 
    ...
    #Alpha 2.0 is to be made only make precise defense when hitting to us 
        ...
        return ioin(paddle_frect,iay)[1]
