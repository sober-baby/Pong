...
def init_game():
    ...
    import chaser_ai
    import test_tounament
    import pong_ai
    import pong_ai_regular
    import pong_alpha2_0
    import pong_alpha3_0
    import pong_alpha1_0
    import pong_alpha1_x
    import pong_ai_2xxx
    import pong_ai_3xxxx

    paddles[0].move_getter = pong_ai.pong_ai
    paddles[1].move_getter = pong_ai_3xxxx.pong_ai #chaser_ai.pong_ai
