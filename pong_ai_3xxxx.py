...
def pong_ai(paddle_frect, other_paddle_frect, ball_frect, table_size):
    ...
    ball_to_pad = dis-paddle_frect.size[0]/2-15/2
    ...
    if bounce_speed_mag!=0:
        ...
        # diff is paddle_frect.size[1]/2-ball_frect.size[1]/2
        def valid(end):
